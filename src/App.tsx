      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-16">
        <div className="flex-1 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <a href="https://apps.apple.com/app/id" className="w-full sm:w-auto px-8 py-4 text-base font-semibold text-white bg-slate-900 rounded-2xl hover:bg-slate-800 hover:-translate-y-1 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group" onClick={(e) => { if (e.currentTarget.getAttribute('href')?.endsWith('/id')) { e.preventDefault(); alert('Apple App Store ID is missing! Bundle ID: com.medvisitapp.ios'); } }}>
